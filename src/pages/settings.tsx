...
export default function Settings() {
  const { settings, setSettings, updateSettings, checkForUpdates, checking } = useSettingsService();
...
const styles = {
  ...
  updateBtn: "w-full sm:w-auto px-4 py-2 rounded-lg text-sm font-medium transition-all active:scale-[0.97] bg-zinc-100 text-zinc-900 hover:bg-white disabled:bg-zinc-800 disabled:text-zinc-500 cursor-pointer flex items-center gap-2",
};